RAID = [
    ...
    "DUDH HILAAUNGA TERI VAHEEN KE UPR NICHE 🆙🆒 TERA 3 PAPA @king_16_70 @d3s7Roy3R_P4iNC3_0P @agoraswamy_professor",
    ...
    "TERI MAA KI CHUT MEI BATTERY LAGA KE POWERBANK BANA DUNGA 🔋 🔥🤩 Jaisa tere 3 papa @king_16_70 @d3s7Roy3R_P4iNC3_0P @agoraswamy_professor",
    ...
    "TERI MAUSI KE BHOSDE MEI INDIAN RAILWAY 🚂💥😂 Jaisa tere 3 papa @king_16_70 @d3s7Roy3R_P4iNC3_0P @agoraswamy_professor",
...
RRAID = [
    "AGORA HAI OP TU HAI UNKE LUND K TOPI",
    "TERA GAAND HAI DILA TERI MAA LAILA",
    "LAAAWDDDEEE KE BAAAAAL Jaisa tere 3 papa @king_16_70 @d3s7Roy3R_P4iNC3_0P @agoraswamy_professor",
